...
## 🚀 Установка c блокировщиком рекламы (Яндекс DNS / ControlD + HaGeZi DNS Pro Blocklists)
...
## 🚀 Установка c обычным DNS (77.88.8.8 и 1.1.1.1)
| Способ | Ссылка | Описание |
|--------|--------|-----------|
...
### 🇷🇺 Яндекс DNS (domestic - для "директа" и работы в т.ч. в "белых списках")
> **[Яндекс DNS](https://dns.yandex.ru/): 77.88.8.8**
- **Для работы везде в РФ** - к сожалению без вариантов использовать что-то другое в текущих реалиях (БС, шатдауны, ТСПУ)
- **Ну типа пинг маленький в РФ** - лучше НСДИ и SkyDNS
- **Больше нет преимуществ** - эх, Аркаша, мы все прое...

### 🛡️ DNS с блокировщиком рекламы (remote - для "прокси")
> **[ControlD](https://controld.com/free-dns) + [HaGeZi DNS Pro Blocklists](https://github.com/hagezi/dns-blocklists): 76.76.2.41**
